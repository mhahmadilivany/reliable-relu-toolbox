...
torchpack dist-run -np 1 python search_bounded_model.py --dataset cifar10 --data_path ./dataset/cifar10/cifar10 --model vgg16 --teacher_model vgg16 --init_from ./pretrained_models/vgg16_cifar10_c/checkpoint/best.pt \
